const CACHE="gps-viewer-v21";
const CORE=["./","./index.html","./style.css","./app.js","./v17-fixes.js","./v18-fixes.js","./v19-fixes.js","./v20-fixes.js","./v21-fixes.js","./v15-fixes.js","./v16-fixes.js","./config.js","./digipin.js","./offline-cache.js","./manifest.webmanifest","./favicon.svg","./apple-touch-icon.png","./icon-192.png","./icon-512.png"];
