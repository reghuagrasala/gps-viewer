const CACHE="gps-viewer-v48";
const CORE=["./","./index.html","./style.css","./ui-fix.css?v=48","./app.js","./compass.js","./config.js","./digipin.js","./offline-cache.js","./manifest.webmanifest","./favicon.svg","./apple-touch-icon.png","./icon-192.png","./icon-512.png"];
