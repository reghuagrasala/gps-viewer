const CACHE="gps-viewer-v57";
const CORE=["./","./index.html","./style.css","./ui-fix.css?v=57","./app.js","./compass.js","./config.js","./digipin.js","./offline-cache.js","./manifest.webmanifest","./favicon.svg","./apple-touch-icon.png","./icon-192.png","./icon-512.png"];
